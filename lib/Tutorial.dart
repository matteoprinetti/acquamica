...
class TutorialState extends State<Tutorial>
  ...
  "sensibilizzarvi a un utilizzo più consapevole dell’acqua.",
    ...
    "Si ringraziano il comune di Sanremo, nella persona dell’architetto Mauro Menotti e il consigliere Mario Robaldo e Rivieracqua S.p.a nella persona dell’ing. Paolo Ferrari. Si precisa che diverse fontanelle sono in fase di manutenzione per cui non è garantito l'approvvigionamento d’acqua."
  ];
